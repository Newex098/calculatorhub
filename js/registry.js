...
(function(root, factory) {
  ...
  const CALCULATORS = [
    ...
    },
    {
      ...
      category: 'finance',
      categoryName: 'Finance',
      description: 'Calculate compound interest and total future value from principal, interest rate, compounding frequency, and time.',
      url: 'calculators/compound-interest/index.html',
      fallbackUrl: 'calculator.html',
      isPopular: true,
      isFeatured: false,
      badge: 'Finance',
      keywords: ['compound interest', 'compound interest calculator', 'CI calculator', 'future value', 'interest calculator', 'investment calculator', 'daily compounding', 'monthly compounding', 'annual compounding']
    },
    {
      id: 'simple-interest',
      ...
      category: 'finance',
      categoryName: 'Finance',
      description: 'Calculate simple interest and total maturity amount from principal, annual interest rate, and time period.',
      url: 'calculators/simple-interest/index.html',
      fallbackUrl: 'calculator.html',
      isPopular: true,
      isFeatured: false,
      badge: 'Finance',
      keywords: ['simple interest', 'simple interest calculator', 'SI calculator', 'interest calculator', 'loan interest', 'deposit interest', 'maturity value', 'principal rate time']
    },
    {
      id: 'loan',
      ...
      category: 'finance',
      categoryName: 'Finance',
      description: 'Calculate periodic loan repayments, reducing-balance amortization schedules, total interest, and total cost across monthly, quarterly, and yearly frequencies.',
      url: 'calculators/loan/index.html',
      fallbackUrl: 'calculator.html',
      isPopular: true,
      isFeatured: false,
      badge: 'Finance',
      keywords: ['loan', 'loan calculator', 'reducing balance', 'amortization', 'loan repayment', 'quarterly payment', 'yearly payment', 'amortization schedule', 'borrowing cost', 'interest rate']
    },
    {
      id: 'percentage',
